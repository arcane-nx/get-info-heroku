...
const server = http.createServer(async (req, res) => {
  ...
  const kwikCookies = [
    ...
    'pp_exp_4e5e04716f26fd21bf611637f4fb8a46=1780350420110',
    `kwik_session=${paramKwikSession || '%3D'}`,
    'pp_show_on_4e5e04716f26fd21bf611637f4fb8a46=1',
    `cf_clearance=${paramCfClearance || '265wCz0ERF5mthsQC18r1iI69vNcLl4d1ySb6.YJccE-1780346822-1.2.1.1-O28dz7oit5kkwGbJo5q4lh7rWQrLPUcKXwdG1yChvcwtEHvE5BduOTPLX49jFsMuN_EE8and5PmRwHSJzk7HrLQUaV2Rc.mduzHhmECnjhwMNdVgXlV5.unKbVG0OPbvy93ssx6l7zXKLiWHGwO8cTq2nkx25gWxoWiBDVC4d4veEFPpTWXwW3FJhzEftKbvV8EKNfIlybYwx4PrUMOK.YYhkJ9m5H7PRqgGIwq9oMHYEwyWKF9zOMAwOpV4oMt355RSYtoOJES60CYN._HgkAaPBGmraRQvu2S9OOnFV3mWztSlIB1fVMs_G.XkP3idOYLpBWpzJJrBtfb5_JJ_gLPg5bsiJhalg0GDtOccyVnOWZFOl.Zap8vjUQqNqGXRfgn5gn17fQGyJRl.6jEyfqrban.YFUIOjdE4Tj3VB.g'}`
  ].join('; ');
